          ...
          return (
            ...
            >
              <div className="h-full rounded overflow-hidden shadow-lg bg-white flex flex-col">
                ...
                <div className="flex-grow flex justify-end items-end px-4 py-2">
                  <a
                    className="m-2 mr-1 rounded shadow-md border border-gray-200 bg-white hover:bg-gray-100 px-4 py-3 text-gray-700 uppercase inline-block"
                    href={project.github}
                  ...
                  <a
                    className="m-2 mr-1 rounded shadow-md bg-white border border-gray-200 hover:bg-gray-100 px-4 py-3 text-red-700 uppercase inline-block hidden"
